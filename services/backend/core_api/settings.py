...
SECRET_KEY = 'django-insecure-em)2wx*q&#h3m9gycv9x8df8eru8$gx633bp3+*b8bu51yg7)l'
...
CELERY_RESULT_BACKEND = Path(os.environ['CELERY_RESULT_BACKEND_FILE']).read_text().strip()